...
- `src/refactor_cli/analysis/quality_report.py:164` `_cycles`
- `src/refactor_cli/analysis/quality_report.py:180` `render_quality_report`
- `src/refactor_cli/analysis/quality_report.py:201` `write_quality_report`
